...
public class RecordHistory {
    ...
    private   int  fromUser;//点赞转发者
    @Column(name="to_User")
    private   int  toUser; //被点赞转发者
    @Column(name="comment_id")
    private   int  commentId;  //被点赞的评论
    @Column(name="content_id")
    private   int  contentId;  //被点赞的文章
    @Column(name="aggree_time")
    private    String  aggreeTime;//点赞时间
    @Column(name="view_time")
    private    String  viewTime;//浏览时间
    @Column(name="comment_time")
    private    String  commentTime;//评论时间
    @Column(name="collection_ime")
    private    String  collectionTime;//转发时间
